class scene1 extends Phaser.Scene {
    ...
    preload(){
        ...
        this.load.spritesheet("power-up", "phaser/spritesheets/power-up.png",{
            frameWidth: 16,
            frameHeight: 16
        });
        this.load.spritesheet("player", "phaser/spritesheets/player.png",{
            frameWidth: 16,
            frameHeight: 24
        });
        this.load.spritesheet("beam", "phaser/spritesheets/beam.png",{
            frameWidth: 16,
            frameHeight: 16
        });
        this.load.bitmapFont("pixelFont", "phaser/font/font.png", "phaser/font/font.xml");
    }
